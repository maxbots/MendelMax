...
box = Part.makeBox(extrusion_profile*2+hole_spacing_wide,extrusion_profile,thick_typical)
...
cylinder.translate(Base.Vector(hole_spacing_wide+extrusion_profile*2,0,0))
vertex = vertex.fuse(cylinder)
...
#"tower"
box = Part.makeBox(hole_spacing_wide,extrusion_profile,extrusion_to_z_screw+z_rod_spacing-thick_typical)
box.translate(Base.Vector(extrusion_profile*3/2,0,thick_typical))
vertex = vertex.fuse(box)
cylinder = Part.makeCylinder(extrusion_profile/2,extrusion_to_z_screw+z_rod_spacing-thick_typical)
cylinder.translate(Base.Vector(extrusion_profile*3/2,extrusion_profile/2,thick_typical))
vertex = vertex.fuse(cylinder)
cylinder.translate(Base.Vector(hole_spacing_wide,0,0))
vertex = vertex.fuse(cylinder)

#screw holes
cylinder = Part.makeCylinder(screw_hole_diameter/2,screw_hole_depth)
cylinder.translate(Base.Vector(extrusion_profile*3/2,extrusion_profile/2,extrusion_to_z_screw+z_rod_spacing-screw_hole_depth))
vertex = vertex.cut(cylinder)
cylinder.translate(Base.Vector(hole_spacing_wide,0,0))
vertex = vertex.cut(cylinder)
...
cylinder.translate(Base.Vector(extrusion_profile*3/2+hole_spacing_wide/2,0,extrusion_to_z_screw+z_rod_spacing))
vertex = vertex.cut(cylinder)
...
cylinder.rotate(Base.Vector(0,0,0),Base.Vector(1,0,0),-90)
cylinder.translate(Base.Vector(extrusion_profile*3/2+hole_spacing_wide/2,0,extrusion_to_z_screw))
vertex = vertex.cut(cylinder)
