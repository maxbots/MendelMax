...
tower_x = extrusion_profile/2+hole_spacing_wide
...
cylinder.translate(Base.Vector(plate_x/2-hole_spacing_wide/2,extrusion_profile/2,extrusion_to_z_screw+z_rod_spacing-screw_hole_depth))
vertex = vertex.cut(cylinder)
