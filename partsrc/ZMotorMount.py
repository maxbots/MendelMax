...
hole_spacing = extrusion_y_length-((15+extrusion_diagonal_length+(extrusion_profile/2))*math.sin(math.radians(30))-(extrusion_profile/2)*math.cos(math.radians(30)))*2
box = Part.makeBox(hole_spacing-(extrusion_profile/2*math.cos(math.radians(30))-extrusion_profile/2*math.sin(math.radians(30)))*2,extrusion_profile*math.cos(math.radians(30))+thick_typical,thick_typical)
mount = box
...
box.rotate(Base.Vector(0,0,0),Base.Vector(0,0,1),-60)
box = box.mirror(Base.Vector((hole_spacing-(extrusion_profile/2*math.cos(math.radians(30))-extrusion_profile/2*math.sin(math.radians(30)))*2)/2,0,0),Base.Vector(1,0,0))
...
cylinder.rotate(Base.Vector(0,0,0),Base.Vector(1,0,0),-90)
cylinder.translate(Base.Vector((hole_spacing-(extrusion_profile/2*math.cos(math.radians(30))+extrusion_profile/2*math.sin(math.radians(30)))*2)/2,0,z_rod_spacing))
...
cylinder.rotate(Base.Vector(0,0,0),Base.Vector(1,0,0),-90)
cylinder.translate(Base.Vector((hole_spacing-(extrusion_profile/2*math.cos(math.radians(30))+extrusion_profile/2*math.sin(math.radians(30)))*2)/2-31/2,0,z_rod_spacing-31/2))
cylinder.translate(Base.Vector(extrusion_profile*math.sin(math.radians(30)),extrusion_profile*math.cos(math.radians(30)),0))
mount = mount.cut(cylinder)
...
mount.translate(Base.Vector(-((hole_spacing-(extrusion_profile/2*math.cos(math.radians(30))-extrusion_profile/2*math.sin(math.radians(30)))*2)/2-(7+hole_spacing_wide/2)),0,0))
...
box = Part.makeBox(hole_spacing_wide,extrusion_profile*math.cos(math.radians(30))+thick_typical,z_rod_diameter/2+thick_typical)
...
cylinder.rotate(Base.Vector(0,0,0),Base.Vector(1,0,0),-90)
cylinder.translate(Base.Vector(7+hole_spacing_wide/2,0,0))
latch = box.common(cylinder)

#connects the curved part to the bolt holes
box = Part.makeBox(hole_spacing_wide,14,max(thick_typical,thick_compress))
box.translate(Base.Vector(7,0,0))
...
cylinder = Part.makeCylinder(7,thick_compress+nut_depth)
cylinder.translate(Base.Vector(7+hole_spacing_wide,7,0))
mount = mount.fuse(cylinder)
...
nuthole = regPolygon(sides = 6, radius = nut_width/2, extrude = nut_depth, Z_offset = 0)
nuthole.translate(Base.Vector(7+hole_spacing_wide,7,thick_compress))
mount = mount.cut(nuthole)
